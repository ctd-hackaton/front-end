...
export default function Statistics() {
  ...
  const weeklyTotals = useMemo(() => {
    return weekPlan && userGoals
      ? calculateWeeklyTotals(weekPlan, userGoals)
      : { totalNutrition: null, allIngredients: [] };
  }, [weekPlan, userGoals]);
  ...
  const text =
    "Your nutrition plan is on track! Keep up the great work maintaining consistent meal patterns throughout the week.";
    ...
    <div className={styles.mainContent}>
      ...
      <main className={styles.gridLayout}>
        ...
        <section className={styles.rightCol}>
          <WeeklySummaryCard
            ...
            balanceScore={87}
          />
          <TopIngredientsCloud ingredients={cleanIngredients} />
        </section>
      </main>
      <section className={styles.mealsSection}>
        ...
        <div className={styles.mealsGrid}>
          {todayMeals &&
            Object.entries(todayMeals).map(([mealType, mealData]) => (
              <MealSummaryCard
                key={mealType}
                mealType={mealType}
