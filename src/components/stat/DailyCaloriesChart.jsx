...
export function DailyCaloriesChart({ data }) {
  ...
  console.log("DailyCaloriesChart data:", data);
  ...
  useEffect(() => {
    ...
    const tooltipDay = tooltipGroup.append('text')
      .attr('class', 'tooltip-day')
      .style('fill', 'var(--text-primary)')
      .style('font-weight', '600')
      .style('font-size', '14px');

    const tooltipCalories = tooltipGroup.append('text')
      .attr('class', 'tooltip-calories')
      .style('font-weight', '600')
      .style('font-size', '16px');

    const tooltipTarget = tooltipGroup.append('text')
    ...
    g.selectAll('.dot')
      ...
      .on('mouseover', function(event, d) {
        ...
        tooltipCalories
          ...
          .style('fill', isOverTarget ? 'var(--danger)' : 'var(--primary-green)');
        ...
        tooltipBg
          ...
          .attr('stroke', isOverTarget ? 'var(--danger)' : 'var(--primary-green)');
